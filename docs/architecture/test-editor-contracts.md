...
Цена, принятая сознательно: `POST` прошёл, а дозапись упала — тест создан без части настроек.
Ошибка всплывает баннером, автор дозаполняет уже существующий тест. Профиль риска у всех
четырёх строк таблицы одинаковый.
