...
- **Блок каждой темы** — «Введение раздела», строка с вопросами темы («5 вопросов темы
  ...
  исчезает, а гаснет с пометкой «Скрыт от ученика».
...
- скрывать экран от ученика: меню строки «…» → «Скрыть от ученика». Скрытый экран
  остаётся в полотне погашенным, с пометкой «Скрыт от ученика», и возвращается тем же
  меню («Показать ученику»). Экраны, без которых прохождение не состоится — «Старт»,
  «Вопросы», «Итоги теста», «Маршрутизатор», — скрыть нельзя: пункт погашен и называет
  причину. Пока скрывать можно «Итоги раздела»; это то же самое, что переключатель
  «Показывать итоги раздела» («Обратная связь и итоги» → «Во время теста»), — одна
  настройка, два места.
...
То же самое делает пункт «Скрыть от ученика» в меню строки «Итоги раздела» на полотне
сценария (§8.8): это одна настройка в двух местах, и она всегда показывает одно значение.
