...
- Настраивать новый тест можно целиком, не сохраняя его по частям: оформление,
  ...
  записываются одним «Сохранить» вместе с самим тестом. Исключение одно — вкладки
...
запишется одним «Сохранить» вместе с самим тестом. Логотип и другие файлы тоже можно
загрузить сразу.
