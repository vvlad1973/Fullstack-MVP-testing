...
- скрывать экран от ученика: меню строки «…» → «Скрыть». Скрытый экран остаётся в
  ...
  глаза; возвращается он тем же меню — «Показать». У экранов, без которых прохождение
  не состоится («Старт», «Вопросы», «Итоги теста», «Маршрутизатор»), пункт погашен.
  Пока скрывать можно «Итоги раздела»; это то же самое, что переключатель «Показывать
  итоги раздела» («Обратная связь и итоги» → «Во время теста»), — одна настройка, два
  места.
