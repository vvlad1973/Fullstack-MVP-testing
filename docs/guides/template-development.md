...
**Статус:** актуально; соответствует спецификации формата версии 3.7.0 и эталонному шаблону
...
**Версия руководства:** 3.7.0 · **соответствует спецификации формата:** 3.7.0 ·
...
- [Платформа SCORM-шаблонов](../specs/spec-template-platform.md) — формальная
  спецификация формата (источник истины), версия 3.7.0.
