...
превью нет вовсе, рисуется карточкой с прочерком — так и оформляют вариант со смыслом
«ничего не показывать». Без `optionPreviews` параметр остаётся обычным списком.
