...
- [x] **Step 2:** комментарий в [#51](https://github.com/vvlad1973/Fullstack-MVP-testing/issues/51)
      с инструкцией и местом под результаты.

## Task 5: Внесение фактов (ЖДЁТ прогона на стенде)

Прогон делает тот, у кого есть доступ к стенду: зонд собран, инструкция написана,
комментарий в задаче оставлен. До возвращения JSON этот блок не трогается — вносить в
требования нечего.
