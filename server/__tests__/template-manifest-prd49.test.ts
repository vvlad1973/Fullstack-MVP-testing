...
describe("манифест «Стандартного»: объявление надписей (PRD-49)", () => {
  ...
  it("объявляет порядок подблоков итогов ПО ЭКРАНАМ", () => {
    ...
    // PRD-50 FR-28: `breakdown` объявлен ТОЛЬКО на обычном экране итогов. Адаптивная
    // раскладка полос разреза не печатает вовсе — ни вложенных, ни сводных, — и объявить
    // ключ там значило бы обещать блок, которого в макете нет.
